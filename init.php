 ...
 * Description: YITH Purchased Column for WooCommerce allows reactivating the Purchased column removed in the last WooCommerce version (3.0.0 or greather)
 * Version: 1.0.3
 * Author: YITHEMES
...
/* === DEFINE === */
! defined( 'YITH_POIC_VERSION' )            && define( 'YITH_POIC_VERSION', '1.0.3' );
...
if( ! function_exists( 'yith_poic_install_woocommerce_admin_notice' ) ){
    function yith_poic_install_woocommerce_admin_notice () {
        ?>
        <div class="error">
            <p><?php _e ( 'YITH Purchased Column for WooCommerce require WooCommerce version 3.0.0 or greather.', 'yith-woocommerce-additional-uploads' ); ?></p>
        </div>
        <?php
    }
}
